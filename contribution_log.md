...
- test: update project API documentation (update #147)
- refactor: format code style in backend models (update #148)
- style: improve video file upload handling (update #149)
- docs: optimize soccer pitch homography calculation (update #150)
- fix: refine Seaborn heatmap color palette (update #151)
- chore: handle multi-threaded matplotlib hangs (update #152)
- perf: update CORS header middleware options (update #153)
- test: refactor database engine session helper (update #154)
...
- style: enhance database query efficiency (update #163)
...
- test: format code style in backend models (update #168)
- refactor: improve video file upload handling (update #169)
- style: optimize soccer pitch homography calculation (update #170)
...
- test: tweak React progress bar animation timing (update #175)
- refactor: add error safety checks to coordinate calculations (update #176)
- style: clean up temporary directory helper function (update #177)
- docs: optimize SQLite session transactions (update #178)
- fix: tune object tracking bbox overlaps (update #179)
- chore: refine event detector heuristics for shots (update #180)
...
- docs: tune ByteTrack tracking thresholds (update #185)
- fix: add validation unit tests for frame sampling (update #186)
...
- chore: refactor database engine session helper (update #194)
- perf: tweak React progress bar animation timing (update #195)
- test: add error safety checks to coordinate calculations (update #196)
- refactor: clean up temporary directory helper function (update #197)
- style: optimize SQLite session transactions (update #198)
- docs: tune object tracking bbox overlaps (update #199)
- fix: refine event detector heuristics for shots (update #200)
